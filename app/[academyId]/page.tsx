...
export default function AcademyOnboardingPage() {
  ...
  const handleStartCall = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assistantId = "ab0c4b79-90aa-411e-9623-5adbc8e0f944";
          ...
          {isCallActive && (
            <div className="flex flex-col items-center w-full space-y-12">
              ...
              <div className="relative w-48 h-48 flex items-center justify-center">
                {/* Pulse Rings */}
                <div
                  className={`absolute inset-0 bg-[#D97948]/20 rounded-full ${
                    isAssistantSpeaking ? "animate-ping" : ""
                  }`}
                />
                <div
                  className={`absolute inset-4 bg-[#D97948]/30 rounded-full ${
                ...
                {/* Central Orb */}
                <div
                  className={`w-32 h-32 rounded-full bg-gradient-to-br from-[#D97948] to-[#ff9f76] shadow-[0_0_40px_rgba(217,121,72,0.6)] flex items-center justify-center transition-all duration-300 ${
